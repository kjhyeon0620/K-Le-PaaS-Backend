...
| **인증** | GitHub OAuth2, JWT (HS256, 액세스/리프레시), CLI Access Token, 웹 승인형 CLI 로그인 |
...
`backend/.env` 또는 실행 환경 변수에 아래 값도 함께 설정 권장:
...
- 사람 사용자:
  ...
  - 브라우저에서 KLEPaaS 웹 승인 페이지를 열고 로그인/승인 후 CLI가 자동 로그인
- 머신/자동화 도구:
